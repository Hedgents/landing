...
const RISKS = [
  ...
  },
  {
    ...
    body: "The closed-beta vault is a tracked-custody model: shares are computed and updated by the operator's accounting; there is no external trustee enforcing the calculations or distributions. If the operator is coerced, becomes incapacitated, refuses to honor withdrawals, or simply leaves, depositors have no automatic recovery — the on-chain assets sit inside the operator-controlled wallet. The relationship is bilateral trust at this stage; future versions plan to migrate to multi-sig or DAO governance.",
  },
  {
    number: "08",
    label: "Regulatory + offering",
    title: "Not registered. Not a fund. Closed beta.",
    body: "Hedgents is an operator-run execution layer, not a registered investment vehicle. The closed beta records depositor shares as a tracked custody — no securities registration, no audited financials, no transfer restrictions enforced by an external agent. Regulatory frameworks for on-chain yield products are still forming; future rules may restrict access, require disclosures we cannot meet, or trigger an orderly unwind.",
  },
  {
    number: "09",
    label: "Economics",
